...
const MyHotels = () => {
  ...
  return (
    ...
    <div className="space-y-5">
        ...
        {hotelData.map((hotel)=>{
             return <div key={hotel._id} className="flex flex-col justify-between border border-slate-300 rounded-lg p-8 gap-5">
                ...
                <span className="flex justify-end">
                    <Link  className="flex bg-blue-600 text-white text-xl font-bold p-2 hover:bg-blue-500" to={`/edit-hotel/${hotel._id}`}>View Deatail</Link>
                </span>
                </div>
            })}
